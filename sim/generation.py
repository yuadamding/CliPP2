...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--out-dir", default="CliPP2Sim", help="Directory to write simulated tumor folders.")
    ...
    parser.add_argument("--n-samples-list", default="2,5,10,15", help="Comma-separated region-count values.")
    ...
    parser.add_argument("--lineage-zero-prob", type=float, default=0.0, help="Probability of zeroing a lineage in a region. Default is 0.0 because clone CCF is now constrained to stay positive in every region.")
