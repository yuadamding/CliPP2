...
def _raw_qualification(fit: RawFit, data: TumorData) -> dict[str, object]:
    ...
    return {
        ...
        "witness_branches_reused": list(certificate.witness_branches_reused),
        "witness_reuse_basis": str(certificate.witness_reuse_basis),
        "witness_reuse_audit_failures": [list(failure) for failure in certificate.witness_reuse_audit_failures],
