...
def _select_representative_files_with_filter(
    ...
    *,
    ...
    if selection_group_cols is None:
        selection_group_cols = ["N_mean", "true_K", "purity", "amp_rate", "n_samples"]
        ...
        for case_index, file_path in enumerate(files, start=1):
            ...
            if case_index % max(flush_every, 1) == 0 or case_index == total_files:
                patient_df = (
                    ...
                    .sort_values(["N_mean", "purity", "amp_rate", "n_samples", "true_K", "rep"])
                ...
                print(
                    f"[cohort-benchmark] {case_index}/{total_files} cases "
